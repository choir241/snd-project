...
const Booking = () => {
  ...
  return (
    <SndSiteWrapper>
      ...
      {/* Hero */}
      <section className="hero-section hero-booking">
        <div className="container py-5 hero-content">
          <div className="row py-5">
            ...
            >
              <h2 className="page-title display-3 mt-5 text-white">Booking</h2>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-5 mt-4">
        <div className="col-12 text-center">
          <p className="fs-3">This part of the website is currently under development. Please <a href="tel:+1704-561-1927" target="_blank" rel="noopener noreferrer">call</a> for booking or inquiries!</p>
        </div>
      </section>
